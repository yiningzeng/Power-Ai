...
export declare type RegionUpdateFunction = (id: string, regionData?: RegionData) => void;
export declare type RegionSelectionFunction = (id: string, multiselection?: boolean) => void;
/**
