...
import RemoteTrainForm from "./remoteTrainForm";
 ...
 */
export interface IProjectSettingsPageProps extends RouteComponentProps, React.Props<RemoteTrainPage> {
    project: IProject;
...
export default class RemoteTrainPage extends React.Component<IProjectSettingsPageProps, IProjectSettingsPageState> {
